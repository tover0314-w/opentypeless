...
TRUSTED_POLICY_CANONICAL_SHA256 = "535d7206a29bfb8ef43acd60f125885edc4498dac591f1a14858f89b115da290"
...
def _validate_policy(value: dict[str, object]) -> Contract:
    ...
    if not isinstance(raw_expectations, list) or len(raw_expectations) != 80:
        raise PolicyError("artifact expectations must contain the exact eighty reviewed APKs")
    expectation_keys = {
