...
TRUSTED_POLICY_CANONICAL_SHA256 = "7135e09dadbb8d49ef09983e16fe29673a193f84450e264e7adf9e9fd3a5dad5"
...
def _validate_policy(value: dict[str, object]) -> Contract:
    ...
    if not isinstance(raw_expectations, list) or len(raw_expectations) != 62:
        raise PolicyError("artifact expectations must contain the exact sixty-two reviewed APKs")
    expectation_keys = {
