...
TRUSTED_POLICY_CANONICAL_SHA256 = "b7f1ae379b504247beaff24a2edb50751c83d4a116b54a0c6d1388a7f8bed9c5"
...
def _validate_policy(value: dict[str, object]) -> Contract:
    ...
    if not isinstance(raw_expectations, list) or len(raw_expectations) != 74:
        raise PolicyError("artifact expectations must contain the exact seventy-four reviewed APKs")
    expectation_keys = {
