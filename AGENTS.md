...
> 本文件的安全约束高于单个任务提示。
> 规范包入口：[`docs/opentypeless_specs/00_README.md`](docs/opentypeless_specs/00_README.md)。
> ADR 入口：[`docs/adr/README.md`](docs/adr/README.md)；模板：[`docs/adr/0000-template.md`](docs/adr/0000-template.md)。
